...
#ifndef ALL_GATHER_HALF_RING_DIRECT_PUB_H
#define ALL_GATHER_HALF_RING_DIRECT_PUB_H
...
namespace hccl {
class AllGatherHalfRingDirect : public ExecutorBase {
public:
    explicit AllGatherHalfRingDirect(const HcclDispatcher dispatcher, const HcomCollOpInfo *opInfo,
    ...
    ~AllGatherHalfRingDirect() override;
...
#endif /* ALL_GATHER_HALF_RING_DIRECT_PUB_H */